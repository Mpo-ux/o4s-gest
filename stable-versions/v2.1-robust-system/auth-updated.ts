    ...
    (set, get) => ({
      ...
      logout: () => {
        ...
        if (currentState.token) {
          makeApiRequest(`${API_BASE_URL}/auth/logout`, {
            method: "POST",
            headers: {
        ...
        console.log(
          "🚪 Logout realizado - sessão e servidores terminados imediatamente"
        );
      },
